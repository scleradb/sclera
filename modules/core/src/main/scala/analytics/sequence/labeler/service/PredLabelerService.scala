...
package com.scleradb.analytics.sequence.labeler.service
...
object PredLabelerService extends ScleraServiceLoader(
    ...
    def apply(idOpt: Option[String] = None): PredLabelerService =
        apply(idOpt getOrElse ScleraConfig.defaultPredLabelerService)
}
